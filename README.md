...
Расположенная рядом кнопка **Переключиться на другую ветку...** с Git-иконкой открывает штатное окно EGit для выбора
произвольной локальной ветки, remote-tracking ветки, тега или другого ref. Это обычное переключение EGit без
автоматического fetch или обновления из remote.
